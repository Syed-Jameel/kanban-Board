...
import moodbaordOne from "../assets/moodboard1.png";
import moodbaordTwo from "../assets/moodboard2.png";
                                ...
                                <div className="bg-[#FFFFFF] rounded-lg p-4 my-4">
                                  ...
                                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-2 pt-4">
                                    <div className="flex items-center">
                                      <img src={inviteOne} className="w-6 h-6" />
                                      <img src={inviteTwo} className="-ml-2 w-6 h-6" />
                                      <img src={inviteThree} className="-ml-2 w-6 h-6" />
                                    </div>
